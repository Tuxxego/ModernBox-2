...
var zombietarantula = AssetManager.actor_library.clone("zombietarantula", "zombie");
 ...
 var alienwisp = AssetManager.actor_library.clone("alienwisp", "butterfly");
       alienwisp.nameLocale = "alienwisp";
       alienwisp.race = "insect";
       alienwisp.kingdom = "neutral_animals";
       alienwisp.texture_path = "alienwisp";
       alienwisp.canAttackBuildings = false;
        AssetManager.actor_library.add(alienwisp);
        AssetManager.actor_library.CallMethod("loadShadow",alienwisp);
        AssetManager.actor_library.CallMethod("addTrait", "light_lamp");
        Localization.addLocalization(alienwisp.nameLocale,alienwisp.nameLocale);

   var pantherax = AssetManager.actor_library.clone("pantherax", "cat");
       pantherax.nameLocale = "pantherax";
       pantherax.animation_walk = "walk_0,walk_1,walk_2";
       pantherax.texture_path = "pantherax";
       pantherax.kingdom = SK.crocodiles;
		pantherax.race = SK.crocodiles;
       pantherax.job = "animal";
       pantherax.fmod_spawn = "event:/SFX/UNITS/Crocodile/CrocodileSpawn";
		pantherax.fmod_attack = "event:/SFX/UNITS/Crocodile/CrocodileAttack";
		pantherax.fmod_idle = "event:/SFX/UNITS/Crocodile/CrocodileIdle";
		pantherax.fmod_death = "event:/SFX/UNITS/Crocodile/CrocodileDeath";
       pantherax.base_stats[S.max_age] = 200;
       pantherax.base_stats[S.health] = 220;
       pantherax.base_stats[S.speed] = 50f;
       pantherax.base_stats[S.armor] = 30f;
       pantherax.base_stats[S.attack_speed] = 60f;
       pantherax.base_stats[S.damage] = 30f;
       pantherax.base_stats[S.knockback] = 0f;
       pantherax.base_stats[S.knockback_reduction] = 2f;
       pantherax.base_stats[S.targets] = 6f;
       pantherax.action_liquid = new WorldAction(ActionLibrary.swimToIsland);
       pantherax.landCreature = true;
        AssetManager.actor_library.add(pantherax);
        AssetManager.actor_library.CallMethod("loadShadow",pantherax);
        AssetManager.actor_library.CallMethod("addTrait", "strong");
        AssetManager.actor_library.CallMethod("addTrait", "flesh_eater");
        Localization.addLocalization(pantherax.nameLocale,pantherax.nameLocale);

         var pterax = AssetManager.actor_library.clone("pterax", "penguin");
                  pterax.id = "pterax";
                  pterax.texture_path = "pterax";
                  pterax.race = "penguins";
                  pterax.kingdom = "penguins";
                  pterax.job = "animal_herd";
                  pterax.landCreature = true;
		          pterax.oceanCreature = true;
		          pterax.swampCreature = true;
                  pterax.speedModLiquid = 1f;
                  pterax.action_liquid = null;
                  pterax.base_stats[S.health] = 120;
                  pterax.base_stats[S.damage] = 13f;
                  pterax.base_stats[S.speed] = 70f;
                  pterax.diet_meat = true;
                pterax.diet_grass = true;
		pterax.diet_vegetation = true;
		pterax.diet_flowers = true;
		pterax.diet_crops = true;
		pterax.diet_berries = true;
		pterax.diet_meat_insect = true;
                  pterax.source_meat = true;
                  pterax.animation_idle = "idle_0,idle_1,idle_2,idle_3,idle_4,idle_5";
                  pterax.animation_walk = "walk_0,walk_1,walk_2,walk_3,walk_4,walk_5";
		          pterax.fmod_spawn = "event:/SFX/UNITS/Penguin/PenguinSpawn";
		          pterax.fmod_attack = "event:/SFX/UNITS/Penguin/PenguinAttack";
		          pterax.fmod_idle = "event:/SFX/UNITS/Penguin/PenguinIdle";
		          pterax.fmod_death = "event:/SFX/UNITS/Penguin/PenguinDeath";
                  pterax.useSkinColors = false;
                  pterax.maxRandomAmount = 6;
                  pterax.moveFromBlock = true;
                  pterax.dieOnBlocks = false;
                  pterax.flying = true;
                  pterax.very_high_flyer = true;
                  AssetManager.actor_library.CallMethod("addTrait", "weightless");
                  AssetManager.actor_library.CallMethod("addTrait", "gluttonous");
                  AssetManager.actor_library.add(pterax);
                    AssetManager.actor_library.CallMethod("loadShadow", pterax);
                  Localization.addLocalization(pterax.nameLocale,pterax.nameLocale);

                   var rhinokinglor = AssetManager.actor_library.clone("rhinokinglor", "rhino");
                  rhinokinglor.id = "rhinokinglor";
                  rhinokinglor.texture_path = "rhinokinglor";
                       rhinokinglor.race = "rhinokinglor";
                  rhinokinglor.kingdom = "neutral_animals";
                         rhinokinglor.job = "animal_herd";
                        rhinokinglor.base_stats[S.armor] = 30f;
                  		rhinokinglor.fmod_spawn = "event:/SFX/UNITS/Rhino/RhinoSpawn";
		rhinokinglor.fmod_attack = "event:/SFX/UNITS/Rhino/RhinoAttack";
		rhinokinglor.fmod_idle = "event:/SFX/UNITS/Rhino/RhinoIdle";
		rhinokinglor.fmod_death = "event:/SFX/UNITS/Rhino/RhinoDeath";
		            rhinokinglor.useSkinColors = false;
                  AssetManager.actor_library.CallMethod("addTrait", "giant");
                     AssetManager.actor_library.CallMethod("addTrait", "tough");
                  AssetManager.actor_library.add(rhinokinglor);
                  AssetManager.actor_library.CallMethod("loadShadow", rhinokinglor);
                                    Localization.addLocalization(rhinokinglor.nameLocale,rhinokinglor.nameLocale);


                 var geckoid = AssetManager.actor_library.clone("geckoid", "cow");
                  geckoid.id = "geckoid";
                  geckoid.texture_path = "geckoid";
                    geckoid.animation_walk = "walk_0,walk_1,walk_2";
		geckoid.fmod_spawn = "event:/SFX/UNITS/Buffalo/BuffaloSpawn";
		geckoid.fmod_attack = "event:/SFX/UNITS/Buffalo/BuffaloAttack";
		geckoid.fmod_idle = "event:/SFX/UNITS/Buffalo/BuffaloIdle";
		geckoid.fmod_death = "event:/SFX/UNITS/Buffalo/BuffaloDeath";
                    AssetManager.actor_library.add(geckoid);
                  AssetManager.actor_library.CallMethod("loadShadow", geckoid);
       ...
       peones.texture_path = "peones";
       peones.job = "animal_herd";
       peones.action_liquid = new WorldAction(ActionLibrary.swimToIsland);
       peones.landCreature = true;
        AssetManager.actor_library.add(peones);
        AssetManager.actor_library.CallMethod("loadShadow",peones);
        AssetManager.actor_library.CallMethod("addTrait", "bubble_defense");
        Localization.addLocalization(peones.nameLocale,peones.nameLocale);

        var xenodogo = AssetManager.actor_library.clone("xenodogo", "cat");
       xenodogo.nameLocale = "xenodogo";
       xenodogo.animation_walk = "walk_0,walk_1,walk_2";
       xenodogo.animation_idle = "idle_0,idle_1,idle_2";
       xenodogo.texture_path = "xenodogo";
       xenodogo.job = "animal_herd";
       xenodogo.action_liquid = new WorldAction(ActionLibrary.swimToIsland);
       xenodogo.landCreature = true;
        AssetManager.actor_library.add(xenodogo);
        AssetManager.actor_library.CallMethod("loadShadow",xenodogo);
        AssetManager.actor_library.CallMethod("addTrait", "bubble_defense");
        Localization.addLocalization(xenodogo.nameLocale,xenodogo.nameLocale);

               BuildingAsset AlienJungle_tree = AssetManager.buildings.clone("AlienJungle_tree", "tree");
            AlienJungle_tree.affected_by_drought = true;
		    AlienJungle_tree.burnable = true;
		    AlienJungle_tree.draw_light_area = true;
		    AlienJungle_tree.draw_light_size = 0.1f;
            AlienJungle_tree.limit_per_zone = 20;
            AlienJungle_tree.canBePlacedOnlyOn = List.Of<string>(new string[]{"AlienJungle_low","AlienJungle_high"});
            AlienJungle_tree.spread_ids = List.Of<string>(new string[]{"AlienJungle_tree"});
            AlienJungle_tree.setShadow(0.5f, 0.03f, 0.12f);
            AssetManager.buildings.addResource("wood", 15, false);
            AssetManager.buildings.addResource("bananas", 5, false);
            AssetManager.buildings.addResource("mushrooms", 5, false);
            AssetManager.buildings.add(AlienJungle_tree);
            AssetManager.buildings.loadSprites(AlienJungle_tree);

            BuildingAsset AlienJungle_plant = AssetManager.buildings.clone("AlienJungle_plant", "swamp_plant");
            AlienJungle_plant.affected_by_drought = true;
		    AlienJungle_plant.burnable = true;
		    AlienJungle_plant.draw_light_area = true;
		    AlienJungle_plant.draw_light_size = 0.1f;
            AlienJungle_plant.wheat = true;
            AlienJungle_plant.limit_per_zone = 1;
            AlienJungle_plant.canBeHarvested = true;
            AlienJungle_plant.setShadow(0.5f, 0.03f, 0.12f);
            AlienJungle_plant.canBePlacedOnlyOn = List.Of<string>(new string[]{"AlienJungle_low","AlienJungle_high"});
            AlienJungle_plant.spread_ids = List.Of<string>(new string[]{"AlienJungle_plant"});
            AssetManager.buildings.addResource("herbs", 1, false);
            AssetManager.buildings.addResource("wheat", 1, false);
            AssetManager.buildings.add(AlienJungle_plant);
            AssetManager.buildings.loadSprites(AlienJungle_plant);

                BiomeAsset AlienJungle = new BiomeAsset();
            AlienJungle.id = "biome_AlienJungle";
			AlienJungle.tile_low = "AlienJungle_low";
			AlienJungle.tile_high = "AlienJungle_high";
			AlienJungle.force_unit_skin_set = "jungle";
			AlienJungle.grow_strength = 20;
			AlienJungle.spread_biome = true;
			AlienJungle.generator_pool_amount = 0;
            AlienJungle.grow_vegetation_auto = true;
			AlienJungle.grow_type_selector_minerals = new GrowTypeSelector(TileActionLibrary.getGrowTypeRandomMineral);
			AlienJungle.grow_type_selector_trees = new GrowTypeSelector(TileActionLibrary.getGrowTypeRandomTrees);
			AlienJungle.grow_type_selector_plants = new GrowTypeSelector(TileActionLibrary.getGrowTypeRandomPlants);
			AlienJungle.addTree("AlienJungle_tree", 9);
			AlienJungle.addPlant("AlienJungle_plant", 9);
            AlienJungle.addUnit("alienwisp", 5);
            AlienJungle.addUnit("pantherax", 2);
            AlienJungle.addUnit("pterax", 5);
            AlienJungle.addUnit("rhinokinglor", 2);
            AlienJungle.addUnit("geckoid", 5);
            AlienJungle.addUnit("peones", 5);
            AlienJungle.addUnit("xenodogo", 5);
			AlienJungle.addMineral(SB.mineral_silver, 20);
            AlienJungle.addMineral(SB.mineral_bones, 20);
            AlienJungle.addMineral(SB.mineral_gems, 6);
            AlienJungle.addMineral(SB.mineral_metals, 6);
            AssetManager.biome_library.add(AlienJungle);
            AssetManager.biome_library.addBiomeToPool(AlienJungle);

            TopTileType AlienJungle_low = AssetManager.topTiles.clone("AlienJungle_low", ST.infernal_low);
            AlienJungle_low.color = Toolbox.makeColor("#4affc8", -1f);
            AlienJungle_low.setBiome("biome_AlienJungle");
			AlienJungle_low.rank_type = TileRank.Low;
            AlienJungle_low.setDrawLayer(TileZIndexes.infernal_low, null);
            AlienJungle_low.food_resource = SR.bananas;
            AlienJungle_low.liquid = false;
            AlienJungle_low.ground = true;
		    AlienJungle_low.stepActionChance = 1f;
            AlienJungle_low.hold_lava = false;
            AlienJungle_low.can_be_frozen = true;
            AlienJungle_low.burnable = true;
            AlienJungle_low.walkMod = 1f;
            AlienJungle_low.layerType = TileLayerType.Ground;
			AlienJungle_low.biome_asset = AlienJungle;
            AssetManager.topTiles.add(AlienJungle_low);
            AssetManager.topTiles.loadSpritesForTile(AlienJungle_low);
            AssetManager.topTiles.add(AssetManager.topTiles.get("AlienJungle_low"));
            MapBox.instance.tilemap.layers[AlienJungle_low.render_z].tilemap.GetComponent<TilemapRenderer>().mode = TilemapRenderer.Mode.Individual;

            TopTileType AlienJungle_high = AssetManager.topTiles.clone("AlienJungle_high", ST.infernal_high);
            AlienJungle_high.color = Toolbox.makeColor("#00d695", -1f);
            AlienJungle_high.setBiome("biome_AlienJungle");
			AlienJungle_high.rank_type = TileRank.High;
            AlienJungle_high.setDrawLayer(TileZIndexes.infernal_high);
            AlienJungle_high.stepActionChance = 1f;
            AlienJungle_high.food_resource = SR.bananas;
            AlienJungle_high.liquid = false;
            AlienJungle_high.hold_lava = false;
            AlienJungle_high.can_be_frozen = true;
            AlienJungle_high.burnable = true;
            AlienJungle_high.layerType = TileLayerType.Ground;
			AlienJungle_high.biome_asset = AlienJungle;
            AssetManager.topTiles.add(AlienJungle_high);
