...
namespace ModernBox
{
    ...
    {
        public static EquipmentAsset MGL;
...
Malorian.path_gameplay_sprite = "items/weapons/w_Glock17";
...
DesertEagle.path_gameplay_sprite = "items/weapons/w_Glock17";
...
DesertEagle.equipment_value = 700;
...
AK.gameplay_sprites = FetchSprites("AK");
            ...
            Americanshotgun.equipment_value = 700;
Americanshotgun.gameplay_sprites = FetchSprites("Americanshotgun");
            ...
            Sluggershotgun.equipment_value = 700;
...
M4A1.metallic = true;
M4A1.setCost(0, "common_metals", 1, "stone", 1);
...
AssetManager.effects_library.add(fx_MGLexplosion_t);
 ...
 ProjectileAsset MGLload = new ProjectileAsset();
          ...
          MGLload.terraform_option = "madness_ball";
          MGLload.terraform_range = 1;
          ...
          AssetManager.projectiles.add(MGLload);
            ...
            MGL = AssetManager.items.clone("MGL", "$range");
            MGL.equipment_type = EquipmentType.Weapon;
            MGL.translation_key = "madness gas launcher";
            MGL.equipment_subtype = "stick";
            MGL.material = "basic";
            MGL.group_id = "firearm";
            MGL.metallic = true;
            MGL.setCost(0, "common_metals", 4, "stone", 2);
            ...
            MGL.path_gameplay_sprite = "items/weapons/w_RPG";
            MGL.projectile = "MGLload";
            MGL.path_slash_animation = "effects/slashes/slash_punch";
            MGL.base_stats["projectiles"] = 5f;
            MGL.base_stats["accuracy"] = -1f;
            MGL.base_stats["attack_speed"] = 100f;
...
AssetManager.effects_library.add(firepower_boom);
            ...
            Flamethrower.setCost(0, "silver", 2);
            ...
            Flamethrower.equipment_value = 790;
Flamethrower.gameplay_sprites = FetchSprites("Flamethrower");
            ...
            Minigun.setCost(0, "silver", 4, "stone", 2);
...
Minigun.gameplay_sprites = FetchSprites("Minigun");
            ...
            Sniper.setCost(0, "wood", 5, "stone", 2);
...
Sniper.gameplay_sprites = FetchSprites("Sniper");
            ...
            M32.metallic = true;
            M32.setCost(0, "adamantine", 1, "stone", 1);
...
ThompsonM1A1.equipment_value = 705;
...
SGT44.metallic = true;
SGT44.setCost(0, "silver", 1, "stone", 1);
