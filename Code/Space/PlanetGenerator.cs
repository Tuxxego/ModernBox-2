    ...
    class PlanetGenerator : MonoBehaviour
    {
        ...
        public static void ChoosePlanetBiomes(string type)
        {
            ...
            DesertPlanet.id = "biome_DesertPlanet";
			      DesertPlanet.tile_low = "DesertPlanet_low";
			      DesertPlanet.tile_high = "DesertPlanet_high";
...
break;
    ...
    case "lava world":
            ...
            LavaPlanet.grow_vegetation_auto = true;
		        ...
		        LavaPlanet.addUnit(Creatures.Terlanius, 1);
    ...
    case "corrupted world":
            ...
            CorruptedPlanet.id = "biome_CorruptedPlanet";
			      CorruptedPlanet.tile_low = "ST.corruption_low";
			      CorruptedPlanet.tile_high = "ST.corruption_high";
