...
dock_rain_human.cost = new ConstructionCost(1, 1, 0, 1); //wood, stone, metals, gold
dock_rain_human.tech = "Renaissance";
dock_rain_human.base_stats[S.health] = 3000f;
...
dock_industrial_human.priority = 400;
...
dock_industrial_human.cost = new ConstructionCost(1, 1, 0, 1); //wood, stone, metals, gold
dock_industrial_human.tech = "Firearms";
dock_industrial_human.base_stats[S.health] = 6000f;
...
dock_modern_human.priority = 500;
...
dock_modern_human.cost = new ConstructionCost(1, 1, 0, 1); //wood, stone, metals, gold
dock_modern_human.tech = "MilitaryModern";
dock_modern_human.base_stats[S.health] = 12000f;
