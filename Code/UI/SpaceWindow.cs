	  ...
	  private static PowersTab getPowersTab(string id) {
        ...
        public static void init()
        {
          ...
          content = GameObject.Find($"/Canvas Container Main/Canvas - Windows/windows/{window.name}/Background/Scroll View/Viewport/Content");
					  ...
					  string Dgold = "#ffae00";
					  var description =
			@"<color='" + gold + @"'>With M2 you can travel to other planets and even galaxies!</color>
			";
					  ...
					  PowerButton GalaxyHub = PowerButtons.CreateButton("GalaxyHub", Resources.Load<Sprite>("ui/Icons/DiesIraeIcon"), "GalaxyHub", "Download and install community created galaxies!", new Vector2(96, MoveDown*2), ButtonType.Click, content.transform, GalaxyHubWindow.openGalaxyHub);	
        }
