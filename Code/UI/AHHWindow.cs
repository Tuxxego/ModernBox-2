...
namespace M2
{
    class AHHWindow
    {
        public static void init()
        {
          ...
          string Dgold = "#ffae00";
          var description =
@"<color='" + gold + @"'>[Nuh uh!!!!]</color>

For now, P9000 Factories are disabled because of balancing, they are too easy to make right now.";
          ...
          name.transform.localPosition = new Vector2(name.transform.localPosition.x, ((nameText.preferredHeight / 2) + 30) * -1);
			Sprite imageSprite = Resources.Load<Sprite>("ui/icons/P9000");
